...
const TractionMetrics = () => {
  // Revenue growth data
  const revenueData = [
    { month: 'Jan 2024', mrr: 2.5, arr: 30, transactions: 450 },
    { month: 'Fév 2024', mrr: 4.2, arr: 50, transactions: 680 },
    { month: 'Mar 2024', mrr: 7.8, arr: 94, transactions: 1200 },
    { month: 'Avr 2024', mrr: 12.5, arr: 150, transactions: 1850 },
    { month: 'Mai 2024', mrr: 18.3, arr: 220, transactions: 2400 },
    { month: 'Jun 2024', mrr: 28.7, arr: 344, transactions: 3200 },
  ];

  // User acquisition data
  const userGrowthData = [
    { month: 'Q1 2024', merchants: 45, volume: 125000, retention: 92 },
    { month: 'Q2 2024', merchants: 128, volume: 340000, retention: 94 },
    { month: 'Q3 2024', merchants: 285, volume: 750000, retention: 96 },
    { month: 'Q4 2024', merchants: 520, volume: 1200000, retention: 97 },
  ];

  // Payment methods performance
  const paymentMethodsData = [
    { method: 'Orange Money', volume: 45, transactions: 2400, growth: 125 },
    { method: 'Wave', volume: 32, transactions: 1800, growth: 98 },
    { method: 'Free Money', volume: 18, transactions: 950, growth: 87 },
    { method: 'Cartes Bancaires', volume: 28, transactions: 1200, growth: 76 },
    { method: 'Wizall', volume: 12, transactions: 650, growth: 65 },
  ];
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="bg-gradient-to-br from-senepay-gold/10 to-senepay-green/10 border-senepay-gold/20">
