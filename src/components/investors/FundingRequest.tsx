...
const FundingRequest = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-black via-senepay-dark to-gray-900">
              ...
              >
                <Card className={`${round.color} border backdrop-blur-sm h-full`}>
                  ...
                  <CardContent className="text-center space-y-3">
                    <Badge className={
                      round.status === 'En cours' ? 'bg-senepay-gold text-black' :
                      round.status === 'Planifiée' ? 'bg-senepay-orange/20 text-senepay-orange border-senepay-orange/30' :
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2 mb-4">
                    <div 
                      className={`h-2 rounded-full bg-gradient-to-r ${
                        allocation.color.includes('gold') ? 'from-senepay-gold to-senepay-orange' :
                        allocation.color.includes('orange') ? 'from-senepay-orange to-senepay-green' :
                        allocation.color.includes('green') ? 'from-senepay-green to-blue-400' :
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <Card className={`border-l-4 ${
                  milestone.status === 'current' ? 'border-l-senepay-gold bg-senepay-gold/5' :
                  milestone.status === 'upcoming' ? 'border-l-senepay-orange bg-senepay-orange/5' :
                  milestone.status === 'planned' ? 'border-l-senepay-green bg-senepay-green/5' :
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                      <div>
                        <Badge className={`mb-2 ${
                          milestone.status === 'current' ? 'bg-senepay-gold text-black' :
                          milestone.status === 'upcoming' ? 'bg-senepay-orange/20 text-senepay-orange border-senepay-orange/30' :
                          milestone.status === 'planned' ? 'bg-senepay-green/20 text-senepay-green border-senepay-green/30' :
