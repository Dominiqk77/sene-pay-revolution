...
const FinancialProjections = () => {
  ...
  // Unit economics data
  const unitEconomics = [
    { metric: 'Customer Acquisition Cost (CAC)', value: '$35', trend: '-22%' },
    { metric: 'Lifetime Value (LTV)', value: '$2,400', trend: '+45%' },
    { metric: 'LTV/CAC Ratio', value: '68.6x', trend: '+85%' },
    { metric: 'Payback Period', value: '2.1 mois', trend: '-35%' },
    { metric: 'Gross Margin', value: '92%', trend: '+3%' },
    { metric: 'Monthly Churn Rate', value: '3%', trend: '-40%' },
  ];
                ...
                <Card className={`bg-gradient-to-br ${scenario.color} border-white/10 backdrop-blur-sm h-full`}>
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      <h5 className="text-white font-semibold">Milestones Clés:</h5>
