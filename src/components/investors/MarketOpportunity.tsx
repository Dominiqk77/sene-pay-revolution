...
const MarketOpportunity = () => {
  ...
  const marketSizeData = [
    { name: 'TAM', value: 25000, color: '#F59E0B', description: 'Total Addressable Market' },
    { name: 'SAM', value: 8500, color: '#EA580C', description: 'Serviceable Addressable Market' },
    { name: 'SOM', value: 2200, color: '#059669', description: 'Serviceable Obtainable Market' },
  ];

  // Growth projection data
  const growthData = [
    { year: '2024', senepay: 0.5, market: 180, penetration: 0.3 },
    { year: '2025', senepay: 4.2, market: 290, penetration: 1.4 },
    { year: '2026', senepay: 25.8, market: 450, penetration: 5.7 },
    { year: '2027', senepay: 68.5, market: 680, penetration: 10.1 },
    { year: '2028', senepay: 145.2, market: 980, penetration: 14.8 },
  ];

  // Regional opportunity data
  const regionalData = [
    { name: 'Sénégal', merchants: 8500, volume: 180, penetration: 11 },
    { name: 'Côte d\'Ivoire', merchants: 12200, volume: 320, penetration: 8 },
    { name: 'Mali', merchants: 4800, volume: 95, penetration: 5 },
    { name: 'Burkina Faso', merchants: 3200, volume: 65, penetration: 4 },
    { name: 'Niger', merchants: 2100, volume: 42, penetration: 3 },
    { name: 'Guinée', merchants: 2800, volume: 58, penetration: 6 },
  ];

  const COLORS = ['#F59E0B', '#EA580C', '#059669', '#3B82F6', '#8B5CF6', '#EF4444'];

  return (
    <section id="market-opportunity" className="py-20 bg-gradient-to-br from-gray-900 to-black">
        ...
        >
          <Card className="bg-gradient-to-br from-senepay-gold/20 to-senepay-orange/20 border-senepay-gold/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300">des sites e-commerce sénégalais n'acceptent pas les paiements en ligne</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-senepay-green/20 to-senepay-orange/20 border-senepay-green/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300">de croissance annuelle du marché e-commerce ouest-africain</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-senepay-orange/20 to-senepay-gold/20 border-senepay-orange/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300">e-commerces potentiels dans la zone CEDEAO d'ici 2026</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
